...
public class EndToEndTest {
	...
	public Response GetAllEmployees() { // This method will give all the employees detail
	...
	public Response GetSingleEmployee(int Empid) { // This method will give single employee detail
	...
	public Response CreateNewEmployee(String name, String salary) { // This method will create a new employee
	...
	public Response UpdateNewEmployee1(int Empid,String NewName,String salary) { // This method will update the new employee
	...
	public Response DeleteNewEmployee(int Empid) { // This method will delete the new employee
		RestAssured.baseURI = this.URI;
		RequestSpecification request = RestAssured.given();
